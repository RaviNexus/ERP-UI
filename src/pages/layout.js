...
const NAV_ITEMS = [
  ...
  { section: 'Business', items: [
    ...
    { id: 'inventory-products', label: 'Products', icon: '📦', path: '/inventory/products', perm: 'inventory.view' },
    { id: 'inventory-warehouses', label: 'Warehouses', icon: '🏠', path: '/inventory/warehouses', perm: 'inventory.view' },
    { id: 'inventory-adjustments', label: 'Stock Adjustments', icon: '📊', path: '/inventory/adjustments', perm: 'inventory.view' },
    { id: 'inventory-config', label: 'Inventory Setup', icon: '⚙️', path: '/inventory/config', perm: 'inventory.view' },
    { id: 'sales-dashboard', label: 'Sales Dashboard', icon: '📈', path: '/sales/dashboard', perm: 'sales.view' },
    { id: 'sales-orders', label: 'Sales Orders', icon: '🛒', path: '/sales/orders', perm: 'sales.view' },
    { id: 'sales-invoices', label: 'Invoices & Billing', icon: '🧾', path: '/sales/invoices', perm: 'sales.view' },
    { id: 'purchase', label: 'Purchase', icon: '🛍️', path: '/purchase/vendors', perm: 'purchase.view' },
  ]},
